...
const Notification = ({
  ...
  return toast.custom(
    t => (
      <div
        className={`flex flex-row items-start justify-between max-w-sm rounded border border-[#00FBFF]/25 shadow-center shadow-accent bg-base-200 p-4 font-mono text-sm transform-gpu relative transition-all duration-500 ease-in-out space-x-2
        ${
