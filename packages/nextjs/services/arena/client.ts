...
export const arenaClient = {
  ...
  // Docker runs call this twice: once to prepare and fund, which parks the run
  // at `ready`, and once from there to send the agents off. Chainless presets
  // go straight through on the first call.
