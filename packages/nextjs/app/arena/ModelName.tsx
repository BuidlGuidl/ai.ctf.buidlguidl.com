...
// Effort annotates the model name, so the two ship as one component — no surface can
// park the effort somewhere else. The tail borrows currentColor from the name it
...
export function ModelName({
  ...
  return (
    <span className={className}>
      ...
      <span className={effort ? "mr-[0.34em]" : undefined}>{model}</span>
